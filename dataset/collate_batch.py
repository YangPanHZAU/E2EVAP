...
def train_collate_batch(batch):
    ...
    inp_mask = {'inp_mask': default_collate([b['inp_mask'] for b in batch])}
    inp_edge = {'inp_edge': default_collate([b['inp_edge'] for b in batch])}
    meta = default_collate([b['meta'] for b in batch])
    data_input.update(inp)
    data_input.update(inp_mask)
    data_input.update(inp_edge)
    ...
    #num_points_per_poly = 160
    #num_points_per_poly = 64
    #num_points_per_poly = 96
    #num_points_per_poly = 32
